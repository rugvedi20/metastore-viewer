...
import { Bot, Send, User, Sparkles, Zap, Database, BarChart2 } from "lucide-react"
              ...
              >
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">Ask questions about your metadata using natural language</p>
                  </div>
                </div>
